...
from noposplat.dataset import DatasetCfgWrapper, get_dataset
from noposplat.dataset.types import DataShim, Stage
from noposplat.dataset.validation_wrapper import ValidationWrapper
...
class DataModule(LightningDataModule):
    ...
    def train_dataloader(self):
        ...
        for dataset in datasets:
            ...
            # print("dataset is IterableDataset: ", isinstance(dataset, IterableDataset))
            # if true, shuffle = False
            # if false, shuffle = True
            data_loaders.append(
                DataLoader(
                    dataset,
