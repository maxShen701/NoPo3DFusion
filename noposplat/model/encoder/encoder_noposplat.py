...
from noposplat.model.encoder.backbone.croco.misc import transpose_to_landscape
from noposplat.model.encoder.heads import head_factory
from noposplat.dataset.shims.bounds_shim import apply_bounds_shim
from noposplat.dataset.shims.normalize_shim import apply_normalize_shim
from noposplat.dataset.shims.patch_shim import apply_patch_shim
from noposplat.dataset.types import BatchedExample, DataShim
from noposplat.geometry.projection import sample_image_grid
from noposplat.model.types import Gaussians
from noposplat.model.encoder.backbone import Backbone, BackboneCfg, get_backbone
from noposplat.model.encoder.common.gaussian_adapter import GaussianAdapter, GaussianAdapterCfg, UnifiedGaussianAdapter
from noposplat.model.encoder.encoder import Encoder
from noposplat.model.encoder.visualization.encoder_visualizer_epipolar_cfg import EncoderVisualizerEpipolarCfg
